...
#ifdef OPTION_VCELL
    valueproviderptr *srfRateValueProvider;  // rate for surface actions:
                                             // asorption, desorption,
                                             // transmission...etc.
#endif
...
typedef struct bngstruct {
    ...
    enum SrfAction ***monomeraction;     // monomer surface actions
                                         // [index][srf][face]
    surfactionptr ***monomeractdetails;  // monomer action details
                                         // [index][srf][face]
...
typedef struct simstruct {
    ...
    surfacecollisionsfnptr surfacecollisionsfn;  // function for surface
                                                 // collisons
    assignmols2boxesfnptr assignmols2boxesfn;    // function that assigns molecs
                                                 // to boxes
    ...
    checkwallsfnptr checkwallsfn;                // function for molecule collisions with
                                                 // walls
...
public:
    ...
    virtual double getValue(
        double t, double x, double y, double z, rxnptr rxn, char *panelName) = 0;
    virtual double getValue(double t, double x, double y, double z,
        surfactionptr actiondetails, char *panelName)                        = 0;
};
